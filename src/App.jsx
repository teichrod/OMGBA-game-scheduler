    ...
    <div style={styles.page}>
      <div style={styles.container}>
        ...
        <div style={styles.tabBar}>
          {(isPublicMode
            ? [["schedule", "Schedule"], ["standings", "Standings"], ["score_reporting", "Score Reporting"], ["technicals", "Technicals"]]
            : [["setup", "Setup"], ["schedule", "Schedule Views"], ["audit", "Audit"], ["debug", "Repeat Debug"], ["issues", "Issues"], ["technicals", "Technicals"]]
          ).map(([key, label]) => (
